...
foreach (string name in studentNames)
{
    ...
    */
    ...
    currentStudentExtraCreditScore = (int)totalExtraCredit / extraCredits;
    currentStudentExamScore = (decimal)totalExamScore / examAssignments;
    currentStudentExtraCreditPoints = (decimal)currentStudentGrade - (decimal)currentStudentExamScore; 
